...
class Customer(models.Model):
    ...
    length = models.FloatField(verbose_name='Длинна', null=True, blank=True, help_text='Длинна')
    width = models.FloatField(verbose_name='Ширина', null=True, blank=True, help_text='Ширина')
    height = models.FloatField(verbose_name='Высота', null=True, blank=True, help_text='Высота')
    volume = models.FloatField(verbose_name='Объем', null=True, blank=True, help_text='Объем')
    capacity = models.FloatField(verbose_name='Грузоподъемность', null=True, blank=True, help_text='Грузоподъемность')
